namespace ZeroMQ.AcceptanceTests.DeviceTests
{
    ...
    {
        public class WhenSendingASingleMessageInBlockingMode : UsingStreamerDevice
        {
        ...
        public class WhenSendingASingleMessageWithAnAmpleTimeout : UsingStreamerDevice
        {
            protected Frame Message;
            protected SendStatus SendResult;
        ...
        public class WhenReceivingASingleMessageWithInsufficientTimeout : UsingStreamerDevice
        {
            protected Frame Message;
        ...
        public class WhenSendingAMultipartMessageInBlockingMode : UsingStreamerDevice
        {
        ...
        public class WhenSendingAMultipartMessageWithAnAmpleTimeout : UsingStreamerDevice
        {
            protected ZmqMessage Message;
            protected SendStatus SendResult1;
            protected SendStatus SendResult2;
        ...
        public class UsingStreamerDevice : UsingThreadedDevice<StreamerDevice>
        {
